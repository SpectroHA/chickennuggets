...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("chickennuggets-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("chickennuggets-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("chickennuggets-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Chickennuggets " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"coreprovision.com", "coreprovision.com"},
    {"", ""},
    {"", ""},
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("chickennuggets-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("chickennuggets-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("chickennuggets-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("chickennuggets-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Chickennuggets is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("chickennuggets-start");
