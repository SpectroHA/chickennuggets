...
void StatisticsPage::updateStatistics() {
    ...
    if (pindexBest->nHeight < 544752) {
        phase = "<p align=\"center\">PoW/PoS</p>";
        ui->progressBar->setMaximum(544752);
    } else {
        ui->progressBar->hide();
    ...
    /*if (volume > volumePrevious) {
        ui->volumeBox->setText("<font color=\"white\">" + qVolume + " CHKN" + "</font>");
    } else if (volume < volumePrevious) {
        ui->volumeBox->setText("<font color=\"red\">" + qVolume + " CHKN" + "</font>");
    } else {
        ui->volumeBox->setText(qVolume + " CHKN");
    }*/
