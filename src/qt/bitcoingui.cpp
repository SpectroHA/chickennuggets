...
{
    resize(1460, 675);
    setWindowTitle(tr("Chickennuggets") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Chickennuggets address"));
    ...
    statisticsAction->setToolTip(tr("CHKN PoW/PoS Statistics"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Chickennuggets"), this);
    aboutAction->setToolTip(tr("Show information about Chickennuggets"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Chickennuggets"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("background: transparent; color: white; font: bold; border: none;");
    ...
    toolbar2->setStyleSheet("background: transparent; color: white; font: bold; border: none;");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Chickennuggets client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Chickennuggets client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Chickennuggets network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Chickennuggets address or malformed URI parameters."));
    }
