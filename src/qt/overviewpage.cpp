...
public:
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(fUseDefaultTheme ? QColor(255, 255, 255) : option.palette.color(QPalette::Text));
...
void OverviewPage::unlockWallet()
{
    ...
    {
        ui->unlockWalletButton->setStyleSheet("background: transparent; color: white; font: bold;");
