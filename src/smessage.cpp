...
// Copyright (c) 2014 The Chickennuggets developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("chickennuggets-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("chickennuggets-smsg-pow"); // Make this thread recognisable
